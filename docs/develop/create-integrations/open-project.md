...
![Home screen with Show more expanded](/img/open-project/home-screen.png)

Click **Open Project** to open the project wizard.

## Choose a source

The wizard presents two options for opening a project.
...
2. A file browser dialog appears. Navigate to the directory that contains your project.
...
1. Click **Open Cloud Project**.
2. If you are not signed in, click **Sign In** to connect your WSO2 account.

   ![Sign in to browse cloud projects](/img/open-project/cloud-sign-in.png)

3. After signing in, the wizard displays the cloud projects available in your organization. Each project shows its name and description.

   ![Cloud projects list](/img/open-project/cloud-projects-list.png)

4. Click on a project to clone it to your local machine and open it in WSO2 Integrator.

## What's next

- [Project View](../project-views/project-view.md) -- Manage, run, and debug your project
- [Create a Project](create-project.md) -- Create a new project from scratch
