...
- [EDI Transformation](../../develop/transform/edi-processing.md) -- EDI data transformation reference
- [FTP EDI to Salesforce](../pre-built/ftp-edi-salesforce-opportunity.md) -- Pre-built sample for EDI to Salesforce
