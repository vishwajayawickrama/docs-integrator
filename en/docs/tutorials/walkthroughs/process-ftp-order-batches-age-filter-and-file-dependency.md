...
description: "End-to-end walkthrough: Build an FTP listener that processes order batch CSV files only after a corresponding marker file signals upload completion, using age filtering to skip files that are too new or too stale, with automatic file deletion after processing."
---
