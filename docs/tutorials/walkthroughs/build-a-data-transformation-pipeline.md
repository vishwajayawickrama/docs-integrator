...
- [Data Mapper](../../develop/transform/visual-data-mapper.md) -- Visual data mapping tool
- [AI-Assisted Mapping](../../develop/transform/ai-assisted-data-mapping.md) -- Use AI to generate transformations
- [Type System](../../develop/transform/type-system-records.md) -- Ballerina's type system for safe transformations
- [Content-Based Routing](route-messages-based-content.md) -- Route messages based on content
