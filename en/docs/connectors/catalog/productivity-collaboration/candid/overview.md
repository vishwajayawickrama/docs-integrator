---
title: Candid Connector Overview
---
...
## Candid connector documentation

* **[Candid Connector Setup Guide](setup-guide.md)**: This guide walks you through obtaining API credentials from Candid to use the connector.
