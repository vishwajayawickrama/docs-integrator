...
* **[Kafka Connector Setup Guide](setup-guide.md)**: This guide walks you through setting up an Apache Kafka cluster and obtaining the connection details required to use the Kafka connector.
