...
This approach requires no additional infrastructure beyond the tracing and metrics backends. See [Metrics](metrics-prometheus-grafana.md) and [Distributed Tracing](distributed-tracing.md) for detailed configuration.
...
- [Metrics](metrics-prometheus-grafana.md) -- Configure Prometheus metrics collection
- [Distributed Tracing](distributed-tracing.md) -- Configure trace exporters
