    ...
    // ─────────────────────────────────────────────
    {
      ...
      items: [
          ...
          items: [
            'develop/integration-artifacts/automation',
            {
              ...
              items: [
                ...
                'develop/integration-artifacts/service/websub-hub-service',
        ...
        // 6.5 Transform (per blueprint)
        {
          ...
          label: 'Transform',
          items: [
            'develop/transform/visual-data-mapper',
            'develop/transform/json-processing',
            'develop/transform/xml-processing',
            'develop/transform/csv-flat-file-processing',
            'develop/transform/edi-processing',
            'develop/transform/yaml-toml-processing',
            'develop/transform/type-system-records',
    ...
    // ─────────────────────────────────────────────
    {
      ...
      items: [
        ...
        // Develop AI Applications
        {
          ...
          items: [
            ...
            // AI Agents
            {
              ...
              label: 'AI Agents',
              items: [
                'genai/develop/agents/ai-agent',
                'genai/develop/agents/adding-tools-agent',
                'genai/develop/agents/adding-memory-agent',
                'genai/develop/agents/advanced-ai-agent-configurations',
                'genai/develop/agents/ai-agent-observability',
                'genai/develop/agents/ai-agent-evaluations',
              ],
            },
            // MCP Integration
            {
              ...
              items: [
                'genai/develop/mcp/mcp-server',
                'genai/develop/mcp/building-ai-agents-mcp-servers',
              ],
            },
          ],
        },
        // Deep Dives — Agents
        {
          ...
          label: 'Agents',
          items: [
            'genai/agents/agent-architecture-concepts',
            'genai/agents/build-chat-agents',
            'genai/agents/expose-agents-as-apis',
            'genai/agents/natural-functions',
            'genai/agents/tool-binding',
            'genai/agents/configure-agent-memory',
        ...
        // Deep Dives — RAG
        {
          ...
          items: [
            ...
            'genai/rag/build-a-rag-service-end-end',
          ],
        },
        // Deep Dives — MCP
        {
        ...
        // Guardrails
        {
          ...
          items: [
            ...
            'genai/guardrails/inputoutput-guardrails',
        ...
        // Quick Starts
        {
          ...
          label: 'Quick starts',
          items: [
            'genai/quick-starts/quick-start-build-a-conversational-agent',
            'genai/quick-starts/quick-start-build-a-rag-application',
            'genai/quick-starts/quick-start-expose-integrations-as-mcp-server',
          ],
        },
        // Tutorials
        {
          ...
          items: [
            ...
            'genai/tutorials/tutorial-ai-customer-support-agent',
            'genai/tutorials/tutorial-conversational-data-pipeline',
            'genai/tutorials/tutorial-mcp-server-enterprise-data',
            'genai/tutorials/tutorial-multi-agent-workflow',
            'genai/tutorials/tutorial-rag-knowledge-base',
          ],
        },
        // Reference
        {
      ...
      items: [
        ...
        // Enterprise Integration Patterns (EIP)
        {
          ...
          items: [
            ...
            'tutorials/patterns/rag-pipeline-pattern',
          ],
        },
        ...
        // Sample Projects
        {
          ...
          items: [
            'tutorials/samples/sample-projects',
      ...
      items: [
        ...
        // CI/CD
        {
          ...
          items: [
            ...
            'deploy-operate/cicd/gitlab-cicd',
      ...
      items: [
        ...
        // CLI
        {
          ...
          items: [
            ...
            'reference/cli/bal-persist-cli',
            'reference/cli/bal-openapi-cli',
            'reference/cli/bal-graphql-cli',
            'reference/cli/bal-grpc-cli',
            'reference/cli/bal-edi-cli',
            'reference/cli/bal-health-cli',
            'reference/cli/ballerina-update-tool',
            'reference/cli/bal-scan-cli',
          ],
        },
        // APIs
        {
          ...
          items: [
            ...
            'reference/api/ballerina-api-documentation',
          ],
        },
        {
          type: 'category',
          label: 'Deploying ICP',
          link: { type: 'doc', id: 'reference/icp/integration-control-plane-icp' },
          items: [
            'reference/icp/server-configuration',
            'reference/icp/database-configuration',
            'reference/icp/authentication',
            'reference/icp/connecting-a-runtime-icp',
        ...
        // Appendix
        {
          ...
          items: [
            ...
            'reference/error-code-reference',
            'reference/glossary',
            'reference/faq',
