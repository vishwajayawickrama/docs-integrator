...
- [Google Sheets to Salesforce Contacts](google-sheets-salesforce-contacts.md) -- Sync spreadsheet data to your CRM
- [FTP EDI to Salesforce Opportunity](ftp-edi-salesforce-opportunity.md) -- Process files from FTP servers
