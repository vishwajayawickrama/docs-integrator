...
## HubSpot CRM engagements communications connector documentation

* **[HubSpot CRM Engagements Communications Connector Setup Guide](setup-guide.md)**: This guide walks you through creating a HubSpot developer app and obtaining the OAuth 2.0 credentials required to use the HubSpot CRM Engagements Communications connector.
