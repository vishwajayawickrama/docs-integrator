...
description: "End-to-end walkthrough: Build a local file watcher that detects new CSV files in a directory, parses and validates each row, writes a summary report, and moves processed files to an archive folder."
---
...
- [CSV processing](../../develop/transform/csv-flat-file-processing.md) — fail-safe parsing, projections, and custom delimiters
