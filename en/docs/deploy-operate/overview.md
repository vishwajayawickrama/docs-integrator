...
**Environment management:** [Environments](deploy/environments.md) | [Managing configurations](deploy/managing-configurations.md) | [Scaling and high availability](deploy/scaling-ha.md)
...
| **[Prometheus and Grafana](observe/prometheus.md)** | Metrics collection and dashboards |
| **[Jaeger and Zipkin](observe/jaeger.md)** | Distributed tracing |
...
- **[API security and rate limiting](secure/api-security.md)** — Protect your endpoints
